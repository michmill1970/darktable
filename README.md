...
## This version of Darktable 5.0.1 contains my fixes for the issue on macOS with Darktable loading images when launched from another program like digiKam.  These changes have been accepted for Darktable 5.2, but I couldn't wait that long.
